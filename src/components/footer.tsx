  ...
  return (
    <>
      <div className="p-5 md:px-10 lg:p-10 bg-primaryGrand text-[3.5vw] md:mt-14 md:text-[2vw] xl:text-[1.1vw] xl:py-7 xl:px-16 2xl:text-[1vw] text-white">
        {/* Address */}
        <div className="grid grid-cols-2 gap-5 md:gap-10 lg:grid-cols-3 xl:py-0">
          <div className="lg:order-2 lg:mx-auto">
            <div className=" flex flex-col gap-3 text-white">
              <p className="font-bold lg:text-[1.5vw] xl:text-[1.2vw] 2xl:text-[1.1vw]">
                Link Terkait
              </p>
              <div className="text-[3.2vw] md:text-[2vw] lg:text-[1.5vw] xl:text-[1.1vw] flex flex-col gap-2">
                <p>Pemerintah Banyumas</p>
                <p>Pengelola Sampah</p>
                <p>IT Telkom Purwokerto</p>
              </div>
            </div>
            <div className="hidden text-white lg:flex lg:flex-col lg:gap-5 lg:mt-10 2xl:text-[1vw]">
              <p className="font-bold lg:text-[1.5vw] xl:text-[1.2vw] 2xl:text-[1.1vw]">
                Contact
              </p>
          ...
          <div className="text-white flex flex-col gap-5 lg:my-0 xl:text-[1vw] lg:hidden 2xl:text-[1vw]">
            <p className="font-bold lg:text-[1.5vw] xl:text-[1.2vw] 2xl:text-[1.1vw]">
              Contact
            </p>
          ...
          <div className="flex gap-5 lg:order-1">
            <div className="flex flex-col gap-10 flex-1">
              <div className="flex flex-col gap-3 ">
                ...
                <p className="text-[3.2vw] md:text-[2vw] lg:text-[1.4vw] xl:text-[1.1vw]">
