    ...
    <div className="mt-10 mb-20 lg:mb-40 lg:mt-20">
      ...
      <div className="w-[90%] mx-auto my-5 lg:w-[70%]">
        ...
        <form className="flex flex-col gap-5 xl:mt-10">
          ...
          <button
            type="submit"
            className="bg-primaryGrand hover:bg-darkGreen text-white rounded-md py-1 text-[3vw] md:text-[2.5vw] md:py-1 lg:py-1 lg:text-[1.3vw] xl:text-[1vw] 2xl:text-[1.3vw]"
          >
            Kirim
          </button>
        </form>
